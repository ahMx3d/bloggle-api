        ...
        <div class="row">
            <div class="col-md-4 col-sm-4 col-7 col-lg-2">
                <div class="logo">
                    <a href="{{ route('frontend.index') }}">
                        <img src="{{ asset('frontend/images/logo/new-logo.png') }}" alt="logo images" />
                    </a>
                </div>
            </div>
            <div class="col-lg-8 d-none d-lg-block">
                <nav class="mainmenu__nav">
                    <ul class="meninmenu d-flex justify-content-start">
                        ...
                        <li class="drop with--one--item">
                            {{-- <a href="{{ route('frontend.posts.show', 'about-us') }}">About Us</a> --}}
                            <a href="{{ route('frontend.pages.show', 'about-us') }}">About Us</a>
                        </li>
                        <li class="drop with--one--item">
                            {{-- <a href="{{ route('frontend.posts.show', 'our-vision') }}">Our Vision</a> --}}
                            <a href="{{ route('frontend.pages.show', 'our-vision') }}">Our Vision</a>
                        </li>
                        <li class="drop"><a href="javascript:void(0)">Categories</a>
                            <div class="megamenu dropdown">
                                <ul class="item item01">
                                    ...
                                    <li>
                                        <a href="{{ route('frontend.categories.posts.show', $category->slug) }}">
                                        {{ $category->name }}
                                        </a>
                                    </li>
                                    @endforeach
                        ...
                        {{-- <li><a href="{{ route('frontend.contacts.show') }}">Contact Us</a></li> --}}
            ...
            <div class="col-md-8 col-sm-8 col-5 col-lg-2">
                <ul class="header__sidebar__right d-flex justify-content-end align-items-center">
                    ...
                    <li class="setting__bar__icon"><a class="setting__active" href="javascript:void(0);"></a>
                                    ...
                                    <div class="switcher-options">
                                        <div class="switcher-currency-trigger">
                                            <div class="setting__menu">
                                                @guest
                                                <span>
                                                    <a href="{{ route('frontend.show_login_form') }}">
                                                        Login
                                                    </a>
                                                </span>
                                                <span>
                                                ...
                                                @else
                                                <span><a href="{{ route('frontend.profile', auth()->user()->username) }}">Profile</a></span>
                                                <span>
                                                    <a
            ...
            <div class="col-lg-12 d-none">
                <nav class="mobilemenu__nav">
                    <ul class="meninmenu">
                        ...
                        <li><a href="{{ route('frontend.pages.show', 'our-vision') }}">Our Vision</a></li>
