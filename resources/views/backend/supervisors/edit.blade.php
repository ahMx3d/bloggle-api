...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        {!! Form::model($user, ['route'=>['admin.supervisors.update', [$user->id,'id'=>$user->id]], 'method'=>'PUT', 'files'=>true]) !!}
        <div class="row">
            <div class="col-4">
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    {!! Form::select('permissions[]', $permissions, old('permissions', $user_permissions),
            ...
            {{-- @if ($user->user_image)
                <div class="col-12 text-center">
                    <div id="image-area">
                        ...
                        <button class="btn btn-danger edit-remove-image">
                            Remove Image</button>
                    </div>
                </div>
            @endif --}}
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            //     $.post("{{ route('admin.supervisors.media.destroy') }}",
            //         {
            //             user_id: '{{ $user->id }}',
            //             _token : '{{ csrf_token() }}'
            //         },
